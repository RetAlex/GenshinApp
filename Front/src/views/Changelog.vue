...
<script>
    export default {
        ...
        data(){
          return {
            changeLog: [
              {version: "Version 1.3 (BETA)", changes: ["Added map feature with mock farm routes", "Moved experience calculation to backend for better reuse", "Bugfixes and optimisations", "Added automated tests for better QA"], date: '29 Apr 2021', link: 'https://github.com/RetAlex/GenshinApp/pull/30'},
