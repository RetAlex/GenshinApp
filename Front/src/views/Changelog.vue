...
<script>
    export default {
        ...
        data(){
          return {
            changeLog: [
              {version: "Version 2.0.1 (Release, Current)", changes: ["Updated map format to be easier to handle", "Modified drop values and images for Inazuma mobs", "Added new Watatsumi & Seirai islands", "Improvements to drop calculations"], date: '5 October 2021', link: 'https://github.com/RetAlex/GenshinApp/pull/71'},
