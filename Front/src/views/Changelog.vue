...
<script>
    export default {
        ...
        data(){
          return {
            changeLog: [
              {version: "Version 2.3 (Current release)", changes: ["'Filter by weapon/character' feature was updated with new characters and weapons", "New mob 'Bathysmal Vishap' was added to the calculator mob list", "Added new characters, mobs and weapons with appropriate images", "Fixed some bugs and enhancements"], date: '15 January 2021', link: 'https://github.com/RetAlex/GenshinApp/releases/tag/2.3'},
              ...
              {version: "Version 1.4", changes: ["Map performance drastically improved with better management of zoom levels", "Added 2 new routes for more Ruin guards and Treasure hoarders farming", "Added roadmap page", "Added feedback feature on `About us` page, now you can leave feedback to make the site better together!", "Small enhancements to UI/UX"], date: '30 June 2021', link: 'https://github.com/RetAlex/GenshinApp/pull/51'},
              ...
              {version: "Version 1.2", changes: ["Added the new DROPS feature for exp calculator!", "Now you can calculate the approximate amount of materials gain from the mob farming along with mora and EXP", "Minor bug fixes and UI improvements", "Added loot table for all the hostiles in WL 7, other WLs are coming shortly."], date: '31 March 2021', link: 'https://github.com/RetAlex/GenshinApp/pull/26'},
