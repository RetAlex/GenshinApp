...
<script>
    export default {
        ...
        data(){
          return {
            changeLog: [
              {version: "Version 2.3 (Current release)", changes: ["'Filter by weapon/character' feature updated with new characters and weapons", "New mob 'Bathysmal Vishap' was added to the calculator mob list", "Added new characters, mobs and weapons with appropriate images", "Fixed some bugs and enhancements"], date: '15 January 2021', link: 'https://github.com/RetAlex/GenshinApp/releases/tag/2.3'},
