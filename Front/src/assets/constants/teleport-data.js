...
export const teleports = {
    ...
    sumeru: [
        {name: "Lokapala Jungle 1, Sumeru", lat: -94.5288739511599, lng: 881.5540730979322, type: 'waypoint'},
        {name: "Lokapala Jungle 2, Sumeru", lat: -138.0105030906997, lng: 883.5286006468402, type: 'waypoint'},
        {name: "Lokapala Jungle 3, Sumeru", lat: -144.29346621227336, lng: 960.0424224524431, type: 'waypoint'},
        {name: "Lokapala Jungle 4, Sumeru", lat: -167.77413801208075, lng: 864.8018386723979, type: 'waypoint'},
        {name: "Lokapala Jungle 5, Sumeru", lat: -199.63760442036894, lng: 849.8689060265574, type: 'waypoint'},
        {name: "Lokapala Jungle 6, Sumeru", lat: -164.33676986879033, lng: 792.8520936307441, type: 'waypoint'},
        {name: "Lokapala Jungle, Sumeru, Statue", lat: -170.3019417543026, lng: 897.9742956623045, type: 'seven'},
        {name: "Under the Umbrella's Shade, Sumeru", lat: -63.202545780713834, lng: 931.8426654592108, type: 'domain'},
        {name: "Steeple of Ignorance, Sumeru", lat: -188.5210825675136, lng: 744.5454929038802, type: 'trial'},
        {name: "Vanarana 1, Sumeru", lat: -212.52979058453005, lng: 691.5348570383364, type: 'waypoint'},
        {name: "Vanarana, Sumeru, Statue", lat: -192.878819305709, lng: 646.8869765208643, type: 'seven'},
        {name: "Vissudha Field 1, Sumeru", lat: -204.756378240534, lng: 532.0140768808667, type: 'waypoint'},
        {name: "Vissudha Field 2, Sumeru", lat: -222.38088173079183, lng: 506.3955567149164, type: 'waypoint'},
        {name: "Vissudha Field 3, Sumeru", lat: -279.78032528732933, lng: 583.7725230093866, type: 'waypoint'},
        {name: "Vissudha Field 4, Sumeru", lat: -303.7620690060404, lng: 636.648059271515, type: 'waypoint'},
        {name: "Vissudha Field 5, Sumeru", lat: -327.26672855900534, lng: 729.7871361523815, type: 'waypoint'},
        {name: "Vissudha Field 6, Sumeru", lat: -246.01596469786352, lng: 724.5702503388013, type: 'waypoint'},
        {name: "Vissudha Field 7, Sumeru", lat: -242.37009960584032, lng: 679.6797180284884, type: 'waypoint'},
        {name: "Vissudha Field, Sumeru, Statue", lat: -300.28162385127035, lng: 689.5561287694239, type: 'seven'},
        {name: "Lost Nursery, Sumeru, Statue", lat: -330.27291583425387, lng: 509.0481742145215, type: 'seven'},
        {name: "Lost Nursery 1, Sumeru", lat: -300.7700131619151, lng: 587.8091675881507, type: 'waypoint'},
        {name: "Lost Nursery 2, Sumeru", lat: -292.5113815310128, lng: 553.5487998536711, type: 'waypoint'},
        {name: "Lost Nursery 3, Sumeru", lat: -328.5136731144381, lng: 561.5645302094332, type: 'waypoint'},
        {name: "Fragment of Childhood Dreams, Sumeru", lat: -345.5248254871084, lng: 666.0544306060178, type: 'domain'},
        {name: "Ashavan Realm 1, Sumeru", lat: -370.28536677086515, lng: 700.3190884375233, type: 'waypoint'},
        {name: "Ashavan Realm 2, Sumeru", lat: -338.520853409171, lng: 613.2818182196097, type: 'waypoint'},
        {name: "Ashavan Realm 3, Sumeru", lat: -385.5283392483606, lng: 515.5156409787407, type: 'waypoint'},
        {name: "Ashavan Realm 4, Sumeru", lat: -480.5426998378264, lng: 598.0566650315521, type: 'waypoint'},
        {name: "Ashavan Realm 5, Sumeru", lat: -606.4579320001998, lng: 619.998652459531, type: 'waypoint'},
        {name: "Ashavan Realm 6, Sumeru", lat: -488.52150269114156, lng: 647.0233274025791, type: 'waypoint'},
        {name: "Ashavan Realm 7, Sumeru", lat: -511.51779796460386, lng: 638.5464760511154, type: 'waypoint'},
        {name: "Ashavan Realm 8, Sumeru", lat: -562.9710847571877, lng: 674.7699477040499, type: 'waypoint'},
        {name: "Ashavan Realm 9, Sumeru", lat: -548.2799433567584, lng: 717.0681052902883, type: 'waypoint'},
        {name: "Ashavan Realm, Sumeru, Statue", lat: -426.0562619536924, lng: 653.7068399273136, type: 'seven'},
        {name: "The Coordinate of Sun and Rain, Sumeru", lat: -569.7242886703785, lng: 694.1289579535676, type: 'domain'},
        {name: "The Dark Valley, Sumeru", lat: -487.25030518869204, lng: 754.6851330028808, type: 'domain'},
        {name: "Tower of Abject Pride, Sumeru", lat: -548.561403074284, lng: 638.1695869547482, type: 'trial'},
        {name: "Ardravi Valley 1, Sumeru", lat: -560.031471079042, lng: 793.5605976204927, type: 'waypoint'},
        {name: "Ardravi Valley 2, Sumeru", lat: -593.4002537933234, lng: 818.7162879748414, type: 'waypoint'},
        {name: "Ardravi Valley 3, Sumeru", lat: -584.5296378123016, lng: 843.0541624749536, type: 'waypoint'},
        {name: "Ardravi Valley 4, Sumeru", lat: -537.6071748366145, lng: 920.7702632517023, type: 'waypoint'},
        {name: "Ardravi Valley 5, Sumeru", lat: -518.5391860765742, lng: 910.3119382758133, type: 'waypoint'},
        {name: "Ardravi Valley 6, Sumeru", lat: -435.52642959550616, lng: 912.809703850279, type: 'waypoint'},
        {name: "Ardravi Valley 7, Sumeru", lat: -492.28154746515617, lng: 858.54629729707262, type: 'waypoint'},
        {name: "Ardravi Valley 8, Sumeru", lat: -436.07912161155974, lng: 793.3340525282265, type: 'waypoint'},
        {name: "Ardravi Valley, Sumeru, Statue", lat: -479.77299222036805, lng: 845.053536835804, type: 'seven'},
        {name: "Avidya Forest, Sumeru, Statue", lat: -351.12589494894064, lng: 908.2403845654198, type: 'seven'},
        {name: "Spire of Solitary Enlightenment, Sumeru", lat: -291.27039509248596, lng: 928.5661389958179, type: 'trial'},
        {name: "Avidya Forest 1, Sumeru", lat: -392.52673513996285, lng: 832.3040730979322, type: 'waypoint'},
        {name: "Avidya Forest 2, Sumeru", lat: -336.7659646978635, lng: 815.2990679847352, type: 'waypoint'},
        {name: "Avidya Forest 3, Sumeru", lat: -306.38535031847135, lng: 872.2794944170539, type: 'waypoint'},
        {name: "Avidya Forest 4, Sumeru", lat: -264.08021865203847, lng: 926.1582413668033, type: 'waypoint'},
        {name: "Avidya Forest 5, Sumeru", lat: -291.52543657602183, lng: 827.8080074406371, type: 'waypoint'},
        {name: "Avidya Forest 6, Sumeru", lat: -260.6321421016758, lng: 817.4147727745121, type: 'waypoint'},
        {name: "Avidya Forest 7, Sumeru", lat: -275.1323712600183, lng: 795.646182354066, type: 'waypoint'},
        {name: "Avidya Forest 8, Sumeru", lat: -251.5160410839777, lng: 775.0665858809249, type: 'waypoint'},
        {name: "Avidya Forest 9, Sumeru", lat: -232.26680494511953, lng: 776.0572906707018, type: 'waypoint'},
        {name: "Joururi Workshop, Sumeru", lat: -281.2800197428726, lng: 851.3071119166591, type: 'domain'},
        {name: "Ashavan Realm 10, Sumeru", lat: -533.263176604696, lng: 549.2733720910898, type: 'waypoint'},
        {name: "Land of Lower Setekh 1, Sumeru", lat: -614.0230686064822, lng: 494.7980848375001, type: 'waypoint'},
        {name: "Land of Lower Setekh, Sumeru, Statue", lat: -606.2758185065927, lng: 520.0462079200512, type: 'seven'},
        {name: "Land of Lower Setekh 2, Sumeru", lat: -643.9818223082709, lng: 499.5439734945168, type: 'waypoint'},
        {name: "Land of Lower Setekh 3, Sumeru", lat: -708.7907901849719, lng: 508.7913815608969, type: 'waypoint'},
        {name: "Land of Lower Setekh 4, Sumeru", lat: -681.6904655049673, lng: 358.3400387101233, type: 'waypoint'},
        {name: "Land of Lower Setekh 5, Sumeru", lat: -707.0346792958376, lng: 412.7913815608969, type: 'waypoint'},
        {name: "Land of Lower Setekh 6, Sumeru", lat: -578.5407137988577, lng: 424.05237493452614, type: 'waypoint'},
        {name: "Land of Lower Setekh 7, Sumeru", lat: -533.0324640985264, lng: 452.79272221621756, type: 'waypoint'},
        {name: "Land of Lower Setekh 8, Sumeru", lat: -485.02826286224644, lng: 339.03727021791366, type: 'waypoint'},
        {name: "Land of Lower Setekh 9, Sumeru", lat: -561.0300197428726, lng: 278.03467828429376, type: 'waypoint'},
        {name: "Land of Upper Setekh 1, Sumeru", lat: -765.159584559153, lng: 470.2678122687629, type: 'waypoint'},
        {name: "Land of Upper Setekh 2, Sumeru", lat: -733.1954114714316, lng: 334.7130638416946, type: 'waypoint'},
        {name: "Land of Upper Setekh 3, Sumeru", lat: -769.0207770230568, lng: 330.78324825195176, type: 'waypoint'},
        {name: "Land of Upper Setekh 4, Sumeru", lat: -866.7847556819518, lng: 332.77886877790434, type: 'waypoint'},
        {name: "Land of Upper Setekh, Sumeru, Statue", lat: -810.036970879263, lng: 409.29888923069245, type: 'seven'},
        {name: "Hypostyle Desert, Sumeru, Statue", lat: -645.2355470035343, lng: 291.34274535291456, type: 'seven'},
        {name: "Hypostyle Desert 1, Sumeru", lat: -779.2752838037934, lng: 256.7989786077138, type: 'waypoint'},
        {name: "Hypostyle Desert 2, Sumeru", lat: -793.291248501657, lng: 124.02359553364317, type: 'waypoint'},
        {name: "Hypostyle Desert 3, Sumeru", lat: -635.2881166709756, lng: 62.006256391496294, type: 'waypoint'},
        {name: "Altar of Mirages, Sumeru", lat: -662.5304780595577, lng: 222.28682333280676, type: 'domain'},
        {name: "Garden of Endless Pillars, Sumeru", lat: -567.7745199426516, lng: 136.53521454642203, type: 'domain'}
    ]
};
